                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="text-center">
                            <div id="modalNilaiRisiko"
                                class="badge fs-4 px-3 py-2 mb-1">-</div>
                            <div id="modalLevelRisiko"
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <button type="button"
                            class="btn btn-sm btn-light btn-numbering position-absolute"
                            style="top:38px; right:8px; z-index:2"
                            data-target="modalPengendalian"
                            disabled>
