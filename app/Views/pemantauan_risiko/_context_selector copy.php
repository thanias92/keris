            ...
            <div class="row">
                ...
                <div class="col-7">
                    ...
                    <div class="pk-filter-row">
                        ...
                        <select class="pk-select" id="pmCsPengelola">
                            <option value="">– Pilih –</option>
                    ...
                    <div class="pk-filter-row">
                        ...
                        <select class="pk-select" id="pmCsKegiatan">
                            <option value="">– Pilih –</option>
                ...
                <div class="col-4 pk-right-side">
                    <div class="pk-filter-row">
                        <label>Tahun</label>
                        <select class="pk-select" id="pmCsTahun" style="width:80px;">
                            <option value="">– Pilih –</option>
                    ...
                    <div class="pk-action-wrapper">
                        <button type="submit" class="btn btn-primary btn-icon"
                            id="pmCsBtnApply" title="Terapkan" disabled>
...
<form id="pmResetForm" method="post"
    action="<?= site_url('pemantauan-risiko/reset-active') ?>"
    style="display:none;">
    <?= csrf_field() ?>
</form>
